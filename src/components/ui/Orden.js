        ...
        <div className="sm:w-1/2 lg:w-1/3 px-2 mb-4" key={orden.id}>
            <div className="p-3 shadow-md bg-white">
                ...
                {orden.orden.map(platillos => (
                    <p className="text-gray-600" key={platillos.id + platillos.cantidad + platillos.nombre}>{platillos.cantidad} {platillos.nombre} </p>
                ))}

                <div className="text-gray-700 font-bold">Total a Pagar: $ {orden.total}</div>
